...
$string['api_seach_by_default'] = 'Search by default';
$string['api_seach_by_default_quick'] = 'Quick Search';
$string['api_seach_by_default_search'] = 'Deep Search';

$string['api_seach_type'] = 'Search type';
$string['api_seach_type_web'] = 'Web';
$string['api_seach_type_file'] = 'File';

$string['api_visible'] = 'Visivel';
$string['api_visible_public'] = 'Public';
$string['api_visible_private'] = 'Private';

$string['config_info1'] = 'The <b class="plagium-badge">PLAGIUM</b> helps you to guarantee the originality of a text, detecting and identifying possible plagiarism.';
$string['config_info2'] = 'You can find more information at <a href="https://www.plagium.com">https://www.plagium.com</a> .Take a <b>free</b> test and read about our latest social media news.';
$string['config_info3'] = 'Informações gerais podem ser encontradas em https://www.plagium.com</p>';
