...
/**
 * database upgrade code for plagium plugin
 *
 * @package      plagiarism_plagium
 * @subpackage   plagiarism
 * @author       Daniel Gockel <dgockel@plagium.com>
 * @copyright    @2015 plagium GmbH
...
function xmldb_plagiarism_plagium_upgrade($oldversion) {
    ...
    if ($oldversion < 2012031201) {
        // Define field value to be dropped from plagium_config
        ...
        upgrade_plugin_savepoint(true, 2012031201, 'plagiarism', 'plagium');
    }
    ...
    if ($oldversion < 2012031204) {
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2012031204, 'plagiarism', 'plagium');
    }
    ...
    if ($oldversion < 2012031300) {
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2012031300, 'plagiarism', 'plagium');
    }
    ...
    if ($oldversion < 2012031400) {
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2012031400, 'plagiarism', 'plagium');
    }
    ...
    if ($oldversion < 2012031402) {
        ...
        $table = new xmldb_table('plagiarism_plagium');
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2012031402, 'plagiarism', 'plagium');
    }

    if ($oldversion < 2012060600) {
        // Add the 'username' field to the plagium_config table
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2012060600, 'plagiarism', 'plagium');
    }
    ...
    if ($oldversion < 2012062501) {
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2012062501, 'plagiarism', 'plagium');
    }

    if ($oldversion < 2015110700) {
        //add nondisclosure field to plagiarism_plagium_config
        $table = new xmldb_table('plagiarism_plagium_config');
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2015110700, 'plagiarism', 'plagium');
    }


    if ($oldversion < 2016052501) {
        //add groups_capabilities field to plagiarism_plagium_config
        $table = new xmldb_table('plagiarism_plagium_config');
        ...
        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2016052501, 'plagiarism', 'plagium');
    }

    if ($oldversion < 2016052502) {

        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2016052502, 'plagiarism', 'plagium');
    }

    if ($oldversion < 2016061401) {

        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2016061401, 'plagiarism', 'plagium');
    }
    if ($oldversion < 2017120601) {

        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2017120601, 'plagiarism', 'plagium');
    }

    if ($oldversion < 2018072301) {

        // plagium savepoint reached
        upgrade_plugin_savepoint(true, 2018072301, 'plagiarism', 'plagium');
    }
    ...
    if ($oldversion < 2018112000) {
        ...
        $table = new xmldb_table('plagiarism_plagium_user');
    ...
    if ($oldversion < 2021060900) {
        $enabled = get_config('plagiarism', 'plagium_use');
